...
<head>
    ...
    <style>
        ...
        .navbar {
            box-shadow: 0 4px 6px rgba(238, 157, 203, 0.1);
        }

        .hero-section {
            background-color: #f45cb2;
        ...
        .card {
            margin-top: 30px;
            box-shadow: 0 4px 8px rgba(247, 67, 172, 0.1);
        }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="{{ asset('assets/images/Mad-For-Makeup-Gloss.png') }}" alt="Logo">
